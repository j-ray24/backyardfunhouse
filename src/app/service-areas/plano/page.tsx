  ...
  const localProjects = [
    {
      ...
      features: ["Professional turf", "Multiple pin positions", "Sand bunkers"]
    },
    {
      type: "Luxury Swimming Pool",
      neighborhood: "Willow Bend",
      features: ["Infinity edge", "Spa integration", "LED lighting"]
    },
    {
      type: "Sport Court Complex",
      neighborhood: "East Plano",
      features: ["Basketball court", "Volleyball net", "Pickleball lines"]
    }
  ]

  const stats = [
    { icon: Users, label: "Plano Projects", value: "120+" },
    { icon: Star, label: "Client Rating", value: "4.9/5" },
    { icon: Award, label: "Local Recognition", value: "Top Rated" },
    { icon: Zap, label: "Project Time", value: "2-4 Weeks" }
  ]

  return (
    <div className="min-h-screen bg-off-white">
      {/* Navigation */}
      <nav className="bg-charcoal text-off-white py-3 sm:py-4 sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between">
            <Link href="/" className="text-lg sm:text-xl lg:text-2xl font-bold text-brass">
              Backyard Funhouse
            </Link>
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-brass via-brass/95 to-brass/90 text-charcoal relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            <MapPin className="h-6 w-6 text-charcoal" />
            <span className="text-charcoal font-semibold">Plano, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Exceptional Outdoor Builds in
            <span className="text-charcoal/80 block">Plano</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-charcoal/90">
            Transforming Plano backyards with world-class outdoor installations. 
            From West Plano to Willow Bend, we create spaces that inspire.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://calendly.com/gobegreat124?background_color=0f1115&text_color=f4f4f2&primary_color=d6b26e" target="_blank" rel="noopener noreferrer">
              <Button variant="secondary" size="xl" className="group bg-charcoal text-off-white hover:bg-charcoal/90">
                Start Your Plano Project
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              See how we've enhanced Plano homes with our premium outdoor installations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {localProjects.map((project, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="h-48 bg-gradient-to-br from-brass/20 to-charcoal/20 rounded-t-lg"></div>
                <CardHeader>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-charcoal/70 max-w-2xl mx-auto">
              We proudly serve all Plano neighborhoods and surrounding areas.
            </p>
          </div>

          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 text-center">
            {[
              "West Plano", "East Plano", "Willow Bend", "Legacy West",
              "Plano Centre", "West Park Village", "Parkside", "Ridgeview Ranch",
              "Wilshire Estates", "Deerfield", "Plano ISD", "Legacy Drive"
            ].map((area, index) => (
      ...
      {/* Contact CTA */}
      <section className="py-20 bg-gradient-to-r from-charcoal to-charcoal/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your Plano Backyard?
          </h2>
