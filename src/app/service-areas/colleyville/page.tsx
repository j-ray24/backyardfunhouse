...
export default function ColleyvillePage() {
  const localProjects = [
    ...
    },
    {
      ...
      neighborhood: "Bransford",
      features: ["Professional lighting", "Custom logos", "Spectator seating"]
    },
    {
      type: "Luxury Putting Green",
      neighborhood: "Glade Road",
      features: ["Professional turf", "Multiple holes", "Sand bunkers"]
    }
  ]

  const stats = [
    { icon: Users, label: "Colleyville Projects", value: "55+" },
    { icon: Star, label: "Client Rating", value: "5.0/5" },
    { icon: Award, label: "Luxury Standard", value: "Premium" },
      ...
      <section className="py-20 bg-gradient-to-br from-emerald/80 via-brass/60 to-charcoal text-off-white relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-brass font-semibold">Colleyville, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Luxury Builds in
            <span className="text-brass block">Colleyville</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-off-white/90">
            Creating extraordinary outdoor experiences in Colleyville's prestigious neighborhoods. 
            From Pleasant Run to Glade Road, we deliver unmatched luxury and craftsmanship.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://calendly.com/gobegreat124?background_color=0f1115&text_color=f4f4f2&primary_color=d6b26e" target="_blank" rel="noopener noreferrer">
              <Button variant="luxury" size="xl" className="group">
                Start Your Colleyville Project
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </a>
            <Link href="/gallery">
              <Button variant="luxury-outline" size="xl">
                View Colleyville Projects
              </Button>
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-charcoal font-serif">
              Recent Colleyville Projects
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Discover how we've transformed Colleyville estates with our luxury outdoor installations.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald to-brass/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your Colleyville Estate?
          </h2>
