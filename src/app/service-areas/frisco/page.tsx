...
export default function FriscoPage() {
  const localProjects = [
    {
      ...
      features: ["Basketball court", "Putting green", "Trampoline area"]
    },
    {
      type: "Championship Basketball Court",
      neighborhood: "West Frisco",
      features: ["Professional lighting", "Custom logos", "Spectator seating"]
    },
    {
      type: "Adventure Playhouse",
      neighborhood: "Frisco Lakes",
      features: ["Castle design", "Rock climbing wall", "Zip line"]
    }
  ]

  const stats = [
    { icon: Users, label: "Frisco Projects", value: "85+" },
    { icon: Star, label: "Client Rating", value: "5.0/5" },
    { icon: Award, label: "Local Awards", value: "8" },
  ...
  return (
    <div className="min-h-screen bg-off-white">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-emerald via-emerald/95 to-emerald/90 text-off-white relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            <MapPin className="h-6 w-6 text-brass" />
            <span className="text-brass font-semibold">Frisco, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Premier Outdoor Builds in
            <span className="text-brass block">Frisco</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-off-white/90">
            Creating extraordinary backyard experiences in Frisco's finest neighborhoods. 
            From Stonebriar to Frisco Lakes, we deliver unmatched quality.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-charcoal font-serif">
              Recent Frisco Projects
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Discover how we've elevated Frisco backyards with our luxury outdoor installations.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-charcoal/70 max-w-2xl mx-auto">
              We serve all Frisco neighborhoods and surrounding communities.
            </p>
          </div>

          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 text-center">
            {[
              "Stonebriar", "West Frisco", "Frisco Lakes", "Panther Creek",
              "Starwood", "Plantation Resort", "Hunters Glen", "Frisco Square",
              "Legacy West", "The Star", "Frisco Station", "Wade Park"
            ].map((area, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-emerald to-emerald/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your Frisco Backyard?
          </h2>
