...
export default function McKinneyPage() {
  const localProjects = [
    ...
    },
    {
      ...
      features: ["Mediterranean design", "Spa integration", "Water features"]
    },
    {
  ...
  const stats = [
    { icon: Users, label: "McKinney Projects", value: "75+" },
    { icon: Star, label: "Client Rating", value: "5.0/5" },
    { icon: Award, label: "Local Recognition", value: "Top Builder" },
      ...
      <section className="py-20 bg-gradient-to-br from-emerald via-emerald/95 to-brass/30 text-off-white relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-brass font-semibold">McKinney, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Premier Outdoor Builds in
            <span className="text-brass block">McKinney</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-off-white/90">
            Creating exceptional backyard experiences in McKinney's finest communities. 
            From Stonebridge to Craig Ranch, we deliver unparalleled quality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://calendly.com/gobegreat124?background_color=0f1115&text_color=f4f4f2&primary_color=d6b26e" target="_blank" rel="noopener noreferrer">
              <Button variant="luxury" size="xl" className="group">
                Start Your McKinney Project
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </a>
            <Link href="/gallery">
              <Button variant="luxury-outline" size="xl">
                View McKinney Projects
              </Button>
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-charcoal font-serif">
              Recent McKinney Projects
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Discover how we've elevated McKinney homes with our luxury outdoor installations.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-charcoal/70 max-w-2xl mx-auto">
              We serve all McKinney neighborhoods and surrounding communities.
            </p>
          </div>

          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 text-center">
            {[
              "Stonebridge", "Adriatica", "Craig Ranch", "Eldorado",
              "Fairview", "Tucker Hill", "Wilmeth Ridge", "Glenwood",
              "Chestnut Square", "Historic Downtown", "Erwin Park", "Towne Lake"
            ].map((area, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-emerald to-emerald/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your McKinney Backyard?
          </h2>
