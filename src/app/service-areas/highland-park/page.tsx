...
export default function HighlandParkPage() {
  const localProjects = [
    {
      ...
      features: ["Professional lighting", "Custom logos", "Premium surfacing"]
    },
    {
      type: "Luxury Pool & Spa",
      neighborhood: "Armstrong Parkway",
      features: ["Infinity edge", "Smart automation", "Outdoor entertainment"]
    },
    {
      type: "Custom Putting Green",
      neighborhood: "Mockingbird Lane",
      features: ["Professional turf", "Multiple pin positions", "Practice areas"]
    }
  ]

  const stats = [
    { icon: Users, label: "Highland Park Projects", value: "95+" },
    { icon: Star, label: "Client Rating", value: "5.0/5" },
    { icon: Award, label: "Park Cities Leader", value: "#1 Builder" },
  ...
  return (
    <div className="min-h-screen bg-off-white">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-charcoal via-charcoal/95 to-brass/30 text-off-white relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            <MapPin className="h-6 w-6 text-brass" />
            <span className="text-brass font-semibold">Highland Park, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Prestigious Builds in
            <span className="text-brass block">Highland Park</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-off-white/90">
            Creating exceptional outdoor experiences in Highland Park's most distinguished estates. 
            From Armstrong Parkway to Mockingbird Lane, we deliver unparalleled luxury.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://calendly.com/gobegreat124?background_color=0f1115&text_color=f4f4f2&primary_color=d6b26e" target="_blank" rel="noopener noreferrer">
              <Button variant="luxury" size="xl" className="group">
                Start Your Highland Park Project
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </a>
            <Link href="/gallery">
              <Button variant="luxury-outline" size="xl">
                View Highland Park Projects
              </Button>
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Discover how we've enhanced Highland Park estates with our luxury outdoor installations.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-charcoal/70 max-w-2xl mx-auto">
              We serve all Highland Park neighborhoods and the greater Park Cities area.
            </p>
          </div>

          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 text-center">
            {[
              "Highland Park West", "Armstrong Parkway", "Mockingbird Lane", "Beverly Drive",
              "Preston Road", "Hillcrest Avenue", "Abbott Avenue", "Euclid Avenue",
              "Lakeside Drive", "Turtle Creek", "Knox Street", "Park Cities"
            ].map((area, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-charcoal to-brass/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your Highland Park Estate?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://calendly.com/gobegreat124?background_color=0f1115&text_color=f4f4f2&primary_color=d6b26e" target="_blank" rel="noopener noreferrer">
              <Button variant="secondary" size="xl" className="bg-brass text-charcoal hover:bg-brass/90">
                ...
                Book Highland Park Consultation
              </Button>
            </a>
