...
export default function DallasPage() {
  const localProjects = [
    {
      ...
      features: ["LED lighting", "Professional surfacing", "Custom logos"]
    },
    {
      type: "Resort-Style Pool",
      neighborhood: "University Park",
      features: ["Infinity edge", "Smart automation", "Outdoor kitchen"]
    },
    {
      type: "Custom Playhouse",
      neighborhood: "Preston Hollow",
      features: ["Multi-level design", "Climbing wall", "Slide system"]
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-off-white">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-charcoal via-charcoal/95 to-charcoal text-off-white relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            <MapPin className="h-6 w-6 text-brass" />
            <span className="text-brass font-semibold">Dallas, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Luxury Outdoor Builds in
            <span className="text-brass block">Dallas</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-off-white/90">
            Transforming Dallas backyards into extraordinary outdoor living spaces. 
            From Highland Park to University Park, we bring luxury to your doorstep.
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-charcoal font-serif">
              Recent Dallas Projects
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              See how we've transformed Dallas neighborhoods with our luxury outdoor builds.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-charcoal/70 max-w-2xl mx-auto">
              We proudly serve all Dallas neighborhoods and surrounding areas.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 text-center">
            {[
              ...
              "East Dallas", "Deep Ellum", "Bishop Arts", "Uptown Dallas",
              "Downtown Dallas", "Oak Cliff", "White Rock Lake", "Turtle Creek"
            ].map((area, index) => (
      ...
      <section className="py-20 bg-gradient-to-r from-charcoal to-charcoal/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your Dallas Backyard?
          </h2>
