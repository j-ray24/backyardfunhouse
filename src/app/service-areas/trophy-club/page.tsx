  ...
  const localProjects = [
    {
      ...
      neighborhood: "Trophy Club Country Club",
      features: ["Basketball court", "Tennis court", "Putting green"]
    },
    {
      type: "Luxury Pool & Spa",
      neighborhood: "Solana",
      features: ["Resort-style design", "Smart automation", "Fire features"]
    },
    {
      type: "Championship Putting Green",
      neighborhood: "Trophy Club Drive",
      features: ["Professional turf", "Multiple holes", "Practice areas"]
    }
  ]

  const stats = [
    { icon: Users, label: "Trophy Club Projects", value: "40+" },
    { icon: Star, label: "Client Rating", value: "5.0/5" },
    { icon: Award, label: "Country Club Quality", value: "Premium" },
      ...
      <section className="py-20 bg-gradient-to-br from-brass via-brass/90 to-emerald/40 text-charcoal relative overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-charcoal font-semibold">Trophy Club, Texas</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Luxury Builds in
            <span className="text-charcoal/80 block">Trophy Club</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-charcoal/90">
            Creating world-class outdoor experiences in Trophy Club's prestigious community. 
            From the Country Club to Solana, we deliver championship-level quality.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://calendly.com/gobegreat124?background_color=0f1115&text_color=f4f4f2&primary_color=d6b26e" target="_blank" rel="noopener noreferrer">
              <Button variant="secondary" size="xl" className="group bg-charcoal text-off-white hover:bg-charcoal/90">
                Start Your Trophy Club Project
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-charcoal font-serif">
              Recent Trophy Club Projects
            </h2>
            <p className="text-xl text-charcoal/70 max-w-3xl mx-auto">
              Discover how we've enhanced Trophy Club estates with our luxury outdoor installations.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-charcoal to-brass/90 text-off-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-serif">
            Ready to Transform Your Trophy Club Estate?
          </h2>
